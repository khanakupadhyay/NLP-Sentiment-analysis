...
#Set the page title
st.set_page_config(page_title="Sentimment Analysis App", page_icon="😊")

# App title and descrption

st.title("Sentiment Analysis App")
st.write("This app predicts the sentiment of text based on different sources.")

# Define the path to the models directory using pathlib for cross_platform compatibility
models_dir = Path('source/models')

# Chech if the models directory exists
...
def load_model_and_vectorizer(source):
    try:
        ...
        model_path = f'models/{source}_model.joblib'
        vectorizer_path = f'models/{source}_vectorizer.joblib'
